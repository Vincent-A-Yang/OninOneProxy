...
beforeEach(() => {
  ...
  // P2-2: lookup(hostname, { all: true }) returns an array of records, not a single object.
  // The mock must match this contract or resolvePinnedIps sees records.length === undefined → null.
