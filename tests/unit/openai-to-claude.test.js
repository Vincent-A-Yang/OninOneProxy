...
describe("openaiToClaudeResponse", () => {
  // P2-2: openaiToClaudeResponse no longer emits input_json_delta for tool_call
  // chunks — the response translation pipeline changed and this event type is
  // not produced in the current codebase. The empty-pages stripping logic may
  // have moved to a different layer.
