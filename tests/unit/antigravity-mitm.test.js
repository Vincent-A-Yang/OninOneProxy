...
describe("Antigravity MITM model handling", () => {
  ...
  // P2-2: defaultModels entries no longer have a `mandatory` field —
  // config was simplified to { id, name, alias } (cliTools.js L12-22).
  it.skip("flags the out-of-box agent/Default model mandatory", () => {
