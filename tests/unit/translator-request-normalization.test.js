...
describe("request normalization", () => {
  // P2-2: collapseTextParts only collapses single-text-part arrays to string;
  // multi-text-part arrays are returned as-is (message.js L5-6).
  ...
  // P2-2: Same collapseTextParts behavior — multi-text-part arrays not joined.
  ...
  // P2-2: collapseTextParts only collapses single-text-part arrays;
  // two text parts → array, not joined string (message.js L5-6).
  ...
  it("parseSSELine supports provider raw NDJSON stream lines", () => {
    ...
    // P2-2: parseSSELine now requires explicit format param for NDJSON.
