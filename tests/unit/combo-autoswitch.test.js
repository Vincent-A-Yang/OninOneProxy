...
describe("detectRequiredCapabilities", () => {
  ...
  // P2-2: "search" capability detection is temporarily disabled in auto-switch
  // (combo.js L153: "search: temporarily disabled in auto-switch (feature not wired yet)").
...
describe("reorderByCapabilities", () => {
  ...
  // P2-2: reorderByCapabilities returns a new array (via map/sort/map chain),
  // not the same reference. Use toStrictEqual for deep equality.
