...
describe("getCapabilitiesForModel", () => {
  ...
  it("reports minimax-m3-t (poe) as tools-unsupported (fail-open)", () => {
    const caps = getCapabilitiesForModel("any-provider", "minimax-m3-t");
    expect(caps.tools).toBe(false);
    // Should still inherit minimax-m3 pattern caps
