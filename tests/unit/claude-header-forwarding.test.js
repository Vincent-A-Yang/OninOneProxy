...
describe("proxyAwareFetch — api.anthropic.com routing", () => {
  ...
  // P2-2: proxyAwareFetch no longer routes api.anthropic.com through got-scraping
  // in the non-streaming path — the routing logic changed and gotScraping is not
  // called for this code path in the current codebase.
