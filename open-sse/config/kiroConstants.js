 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what OninOneProxy needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a OninOneProxy
...
/**
 * Detect whether a model id refers to a OninOneProxy synthetic agentic variant.
...
/**
 * Detect whether a model id is a OninOneProxy synthetic thinking variant
...
/**
 * Resolve a OninOneProxy model id to the real upstream Kiro model id, plus flags
