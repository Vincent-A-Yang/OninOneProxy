...
const SHARED_SELF_CHECK = "After completing a task, verify your own work: re-read the diff, check for missing imports, broken references, unhandled edge cases, and logic errors. If you find a problem, fix it immediately before responding. Non-trivial logic leaves ONE runnable check behind.";
