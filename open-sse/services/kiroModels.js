 ...
 * into OninOneProxy-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are OninOneProxy fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic OninOneProxy variant set for a single upstream Kiro model.
 *
 ...
 * into OninOneProxy variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
