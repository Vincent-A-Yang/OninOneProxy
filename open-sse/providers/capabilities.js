...
export const MODEL_CAPABILITIES = {
  ...
  // Poe: minimax-m3-t variant does not support tool calling (API returns 400).
  // Inherits minimax-m3 pattern caps (vision/reasoning/minimax thinking) + tools:false.
  "minimax-m3-t":      { vision: true, reasoning: true, thinkingFormat: "minimax", contextWindow: 1048576, maxOutput: 512000, tools: false },
