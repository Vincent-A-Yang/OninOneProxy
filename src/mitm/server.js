...
import * as antigravityHandler from "./handlers/antigravity.js";
import * as copilotHandler from "./handlers/copilot.js";
import * as kiroHandler from "./handlers/kiro.js";
import * as cursorHandler from "./handlers/cursor.js";
...
const server = https.createServer(sslOptions, async (req, res) => {
  try {
    ...
    // Anti-loop: skip requests from OninOneProxy
