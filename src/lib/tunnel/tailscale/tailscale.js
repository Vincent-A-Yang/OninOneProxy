...
// Check if a system-level tailscaled is running (uses system socket, not OninOneProxy's custom one).
 ...
 * State always lives in ~/.OninOneProxy/tailscale/ via --statedir.
 */
