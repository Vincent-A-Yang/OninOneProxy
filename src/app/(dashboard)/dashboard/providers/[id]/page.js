...
import { isCustomProvider as isCustomProviderId } from "@/lib/providerNormalization";
...
export default function ProviderDetailPage() {
  ...
  // True for any user-defined provider id (custom-*, openai-compatible-*,
  // anthropic-compatible-*, custom-embedding-*). Used to surface a "Custom"
  // badge in the header — see OninOneProxy 阶段 4.2.
  const isCustomProvider = isCustomProviderId(providerId);
