...
// POST - Apply OninOneProxy as openai-compatible provider (multi-model support)
...
// DELETE - Remove OninOneProxy provider or specific models from config
export async function DELETE(request) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: modelToRemove ? `Model "${modelToRemove}" removed` : "OninOneProxy settings removed from OpenCode",
    });
  } catch (error) {
