...
const PROVIDER_NAME = "oninoneproxy";
...
// Build TOML config for OninOneProxy (openai provider mode)
const buildOninOneProxyConfig = (baseUrl, apiKey, model) => {
...
// Detect OninOneProxy by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildOninOneProxyConfig(baseUrl, apiKey || "sk_oninoneproxy", model);
