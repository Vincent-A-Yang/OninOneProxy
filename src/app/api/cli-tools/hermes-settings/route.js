...
// Detect OninOneProxy by base_url containing localhost/127.0.0.1 or matching tunnel URL
const hasOninOneProxyConfig = (modelCfg) => {
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      installed: true,
      settings: { model },
      hasOninOneProxy: hasOninOneProxyConfig(model),
