...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/mitm"))
    return {
      title: "MITM Proxy",
      description: "Intercept CLI tool traffic and route through OninOneProxy",
      icon: "security",
      breadcrumbs: [],
    };
  ...
  if (pathname.includes("/skills"))
    return {
      title: "Agent Skills",
      description: "Copy a link and paste to your AI to use OninOneProxy — no install needed",
      icon: "extension",
      breadcrumbs: [],
    };
